...
public class Caballero extends Soldado {
    ...
    public Caballero(String reino, int id, int ejercitoID, int reinoID) {
        super(reino, "Caballero" + id, 3 + (int)(Math.random() * 3), 3 + (int)(Math.random() * 2), 3 + (int)(Math.random() * 2), id, true, ejercitoID, reinoID);
        this.montado = false;
