...
public class Juego {
    ...
    private void determinarGanador() {
    	System.out.println("PROMEDIO DE VIDA EJERCITO 1");
        System.out.println(ejercito1.obtenerPromedioVida());      
        System.out.println("PROMEDIO DE VIDA EJERCITO 2");
        System.out.println(ejercito2.obtenerPromedioVida());        
    	if(ejercito1.obtenerPromedioVida() < ejercito2.obtenerPromedioVida()) System.out.println("EL EJÉRCITO 2 ES EL GANADOR");
    	else System.out.println("EL EJÉRCITO 1 ES EL GANADOR");
	}

	private void mostrarDatos() {
        System.out.println("||| DATOS DEL EJÉRCITO 1 |||");
        ...
        System.out.println();
        System.out.println("DATOS DEL EJÉRCITO 2");
        System.out.println("Soldados");
